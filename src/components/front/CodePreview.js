        ...
        <section className="relative py-24 bg-white overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center bg-white/60 backdrop-blur-sm rounded-full px-4 py-2 text-slate-600 text-sm font-medium mb-6 border border-slate-200/60">
                ...
                {/* Code Preview Window */}
                <div className="elegant-preview rounded-2xl overflow-hidden animate-glow">
                    {/* Browser Controls */}
                    <div className="window-controls px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="flex-1 flex justify-center">
                            <div className="address-bar text-slate-300 px-4 py-2 rounded-lg text-sm flex items-center space-x-2 max-w-sm">
                                <Globe className="w-4 h-4 text-slate-400" />
                                <span>codehouse.io/room/abc123</span>
                            </div>
                        </div>
                    ...
                    {/* Application Header */}
                    <div className="header-bar px-6 py-4 flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-sm">React Component Challenge</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-3">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-slate-400 text-sm">2 online</span>
                                </div>
                                <div className="flex -space-x-2">
                                    <div className="user-avatar w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center border-2 border-slate-700">
                                        <span className="text-white text-xs font-medium">A</span>
                                    </div>
                                    <div className="user-avatar w-8 h-8 rounded-full bg-gradient-to-br from-pink-400 to-purple-600 flex items-center justify-center border-2 border-slate-700">
                                        <span className="text-white text-xs font-medium">J</span>
                                    </div>
                                </div>
                            </div>
                            <button className="share-btn text-white px-4 py-2 rounded-lg font-medium text-sm flex items-center space-x-2">
                    ...
                    {/* Code Editor */}
                    <div className="code-area p-4">
                        <div className="bg-slate-900/50 backdrop-blur-sm rounded-lg p-4 font-mono text-sm border border-slate-700/50">
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center space-x-2">
                                    <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
                                    <span className="text-slate-400">components/Counter.jsx</span>
                                </div>
                                <div className="flex items-center space-x-4">
                                    <div className="flex items-center space-x-2">
                            ...
                            <div className="text-slate-300 leading-6 max-h-96 overflow-y-auto">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                        ...
                        <h4 className="text-lg font-semibold text-slate-900 mb-2">Live Collaboration</h4>
                        <p className="text-slate-600">See cursors and changes in real-time</p>
                    </div>
                    <div className="text-center">
                        ...
                        <h4 className="text-lg font-semibold text-slate-900 mb-2">Syntax Highlighting</h4>
                        <p className="text-slate-600">Beautiful code with intelligent highlighting</p>
                    </div>
                    <div className="text-center">
                        <div className="w-12 h-12 bg-gradient-to-br from-amber-100 to-amber-200 rounded-xl flex items-center justify-center mb-4 mx-auto">
                            <Share2 className="w-6 h-6 text-amber-600" />
                        </div>
                        <h4 className="text-lg font-semibold text-slate-900 mb-2">Instant Sharing</h4>
                        <p className="text-slate-600">Share your code with a single click</p>
                    </div>
                </div>
            </div>
        </section>
